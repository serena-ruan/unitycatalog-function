...
def test_function_with_args():
    ...
    with pytest.raises(
        ...
        generate_sql_function_body(func_with_args, "Function with *args", "catalog", "schema")
...
def test_function_with_kwargs():
    ...
    with pytest.raises(
        ...
        generate_sql_function_body(func_with_kwargs, "Function with **kwargs", "catalog", "schema")
...
def test_function_with_mixed_args():
    ...
    with pytest.raises(
        ...
        generate_sql_function_body(func_with_mixed, "Function with mixed *args and **kwargs", "catalog", "schema")
