...
UNITYCATALOG_AI_CLIENT_EXECUTION_TIMEOUT = _EnvironmentVariable(
    "UNITYCATALOG_AI_CLIENT_EXECUTION_TIMEOUT", "120"
)
UC_AI_CLIENT_EXECUTION_RESULT_ROW_LIMIT = _EnvironmentVariable(
    "UC_AI_CLIENT_EXECUTION_RESULT_ROW_LIMIT", "100"
)
